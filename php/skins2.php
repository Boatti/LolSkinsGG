...
if($result = mysqli_query($link, $championQuery)){
 ...
 printf("<div class=\"tablinks\"><img class=\"SkinImage\" onclick=\"openCity(event, '".$row["name_skin"]."')\"src=\"".$row["img_skin"]."\"><span class=\"spann\">".$row["name_skin"]."</span><input  type="text"> <img class=\"heart\" src=\"../images/Heart.png\"></input></div>");
}
